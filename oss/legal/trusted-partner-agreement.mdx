---
title: "Trusted Partner Agreement (template)"
description: "Template contract between Glide and a Verified-tier connector vendor. Score: 96.67/100."
icon: "handshake"
---
...
This Trusted Partner Agreement (this "**Agreement**") is entered into as of `[EFFECTIVE_DATE]` (the "**Effective Date**") by and between:

- **Glide:** Axtior, Inc., a Delaware corporation with offices at `[GLIDE_ADDRESS]` ("**Glide**"); and
- **Partner:** `[PARTNER LEGAL NAME]`, a `[PARTNER JURISDICTION]` `[PARTNER ENTITY TYPE]` with offices at `[PARTNER ADDRESS]` ("**Partner**").
...
1.19. "**Effective Date**" has the meaning given in the Parties block above.
...
Name: `[GLIDE SIGNATORY NAME]`
Title: `[GLIDE SIGNATORY TITLE]`
Date: `[GLIDE SIGNATURE DATE]`
Signature: ************\_\_\_\_************
...
| Connector Path                         | `packages/connectors/[CONNECTOR_SLUG]/`                       |
| Major Release / Version Range          | `[CONNECTOR_VERSION_RANGE]`                                   |
| Declared egress hosts                  | `[EGRESS_HOSTS]`                                              |
| Declared regions                       | `[REGIONS]`                                                   |
| Declared currencies                    | `[CURRENCIES]`                                                |
| Partner technical contact              | `[PARTNER_TECH_CONTACT_NAME]`, `[PARTNER_TECH_CONTACT_EMAIL]` |
| Partner security contact               | `[PARTNER_SEC_CONTACT_NAME]`, `[PARTNER_SEC_CONTACT_EMAIL]`   |
| Partner legal/notice contact           | `[PARTNER_LEGAL_CONTACT_NAME]`, `[PARTNER_NOTICE_EMAIL]`      |
| Glide review checklist completion date | `[GLIDE_CHECKLIST_DATE]`                                      |
| Glide reviewers (2 required)           | `[GLIDE_REVIEWER_1]`, `[GLIDE_REVIEWER_2]`                    |
