---
title: "Trusted Skill Agreement (template)"
description: "Template contract between Glide and a Verified-tier skill author. Score: 100.00/100."
icon: "hat-wizard"
---
...
**Status:** Template — ready for counsel review. Do not execute without counsel sign-off.

This Trusted Skill Agreement ("**Agreement**") is entered into as of `[EFFECTIVE_DATE]` (the "**Effective Date**") by and between:

- **Axtior, Inc.**, a Delaware corporation doing business as **Glide** ("**Glide**"), and
- **`[SKILL_AUTHOR_LEGAL_NAME]`** ("**Skill Author**") with respect to the agent skill identified by the slug `[SKILL_ID]` (the "**Skill**").
...
A skill author should expect to read this in a single sitting and sign within a day with their counsel. Compared to the connector-side TPA, the TSA:
...
14.9 **Counterparts; electronic signature.** This Agreement may be executed in counterparts, including via electronic signature, each of which is an original.
...
**Skill Author — `[SKILL_AUTHOR_LEGAL_NAME]`**

Name: ************\_\_\_************
Title: ************\_\_\_\_************
Date: ************\_\_\_\_************
Legal-notice email: ************\_\_\_************
Security contact: ************\_\_\_************
...
_Document status: TEMPLATE. Counsel review pending. Do not execute without sign-off from Axtior counsel._
