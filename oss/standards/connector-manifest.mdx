...
[`https://glide.co/schemas/agent-banking/draft/connector-manifest.json`](https://glide.co/schemas/agent-banking/draft/connector-manifest.json)
...
3. **At publish time** by the standards-implementer using the JSON Schema document directly:
   ...
   npx ajv-cli validate \
     -s https://glide.co/schemas/agent-banking/draft/connector-manifest.json \
     -d ./my-manifest.json
   ```
