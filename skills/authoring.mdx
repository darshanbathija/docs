...
- [Agent skills catalog](/skills/index) — every skill currently in the repo.
- [Money-safety contracts](/concepts/money-safety-contracts) — F-rules every skill inherits.
- [Threat model](/security/threat-model) — T10 (malicious skill consent under-disclosure).
