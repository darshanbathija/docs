...
[`https://schemas.glide.dev/agent-banking/draft/agent-policy-envelope.json`](https://schemas.glide.dev/agent-banking/draft/agent-policy-envelope.json)
...
- [Money-safety contracts](/concepts/money-safety-contracts) — F5 (atomic policy_version on signer rotation).
- [SkillManifest](/standards/skill-manifest) — how skills consume the envelope.
- [Authoring a skill](/skills/authoring) — 4-tier policy preset pattern.
