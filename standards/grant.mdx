...
[`https://schemas.glide.dev/agent-banking/draft/grant.json`](https://schemas.glide.dev/agent-banking/draft/grant.json) (alias of `scoped-grant-claims`).
...
- [OAuth flow](/agents/oauth-flow) — RFC 7591 + 8707 + PKCE walkthrough.
- [AgentPolicyEnvelope](/standards/agent-policy-envelope) — what `policy_version` references.
- [Money-safety contracts](/concepts/money-safety-contracts) — F3 + F5.
