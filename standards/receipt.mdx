...
[`https://schemas.glide.dev/agent-banking/draft/receipt.json`](https://schemas.glide.dev/agent-banking/draft/receipt.json)
...
- [Money-safety contracts](/concepts/money-safety-contracts) — F1 (RPC verify) + F4 (append-only).
- [Threat model](/security/threat-model) — T4 (audit-log tampering) + T11 (DSAR loophole).
