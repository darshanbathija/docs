...
[`https://schemas.glide.dev/agent-banking/draft/skill-manifest.json`](https://schemas.glide.dev/agent-banking/draft/skill-manifest.json)
...
- [Authoring a skill](/skills/authoring) — partner-PR flow.
- [AgentPolicyEnvelope](/standards/agent-policy-envelope) — the full envelope a skill template constrains.
- [Skill catalog](/skills/index) — every skill currently in the repo.
